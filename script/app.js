...
import * as brain from '../modules/brainteaser.js';
import * as add from '../modules/addwords.js';
import * as dictionary from '../modules/dictionaries.js';
import * as reader from '../modules/reader.js';
import * as login from '../modules/login.js';
import * as jsp from '../modules/jsonProcess.js';
import * as st from '../modules/state.js';
const state = st.state;



(function () {
    AppVisualisationScope().buildApplication();
})();
